...
function clearInputs() {
	...
	function validateForm() {
	    ...
	    var igname = document.forms["myForm"]["oname"].value;
	    ...
	    if (eventname == "") {
	        ...
	        document.getElementById("errorvenue").innerHTML = "Place/Address cannot be empty !";
	        document.getElementById("errorevent").innerHTML = "";
	        document.getElementById("errorstaffincharge").innerHTML = "";
	        document.getElementById("errorfee").innerHTML = "";
	        return false;
	    } else if (igname == "") {
	        document.getElementById("errororganizer").innerHTML = "Organizer name cannot be empty !";
			...
			<div class="animated fadeIn">
				...
				<div class="card">
					<div class="card-header">
						<strong>Outdoor Event Form</strong>  
					</div>
					<div class="card-body card-block">
						...
						<!-- PARENT EVENT -->					
        					...
        					<div class="row form-group">
                              	<div class="col-12 col-md-9"><input type="hidden" id="disabled-input" name="idadmin" value="<c:out value="${user.staffID}" />" class="form-control"></div>
                              	<input type="hidden" name="indoor" value="outdoor" />
                              	<input type="hidden" name="outdoor" value="outdoor" />
                          	</div>
                          	
  						<!-- CHILD EVENT -->
        					<div class="row form-group">
                              	<div class="col col-md-3"><label for="textarea-input" class=" form-control-label">Outdoor Place/Address: </label></div>
								<div class="col-12 col-md-9"><textarea name="ovenue" id="myTextarea" rows="9" cols="53" form="myform"  placeholder="Enter Location.." class="form-control"></textarea><span class="help-block" id="errorvenue" style="color:red;"> </span></div>
                            </div>
         					<div class="row form-group">
                         		<div class="col col-md-3"><label for="text-input" class=" form-control-label">Organizer Name :</label></div>
                            	<div class="col-12 col-md-9"><input type="text" id="text-input" name="oname" placeholder="Enter Organizer Name.." class="form-control"><span class="help-block" id="errororganizer" style="color:red;"></span></div>
                            </div>
