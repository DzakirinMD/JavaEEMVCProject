...
<div id="wrapper">
           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
				   ...
				   <li class='active'><a href="/Test/EventController?action=indoorEvent&email=<c:out value="<%=email%>"/>"><i class="fa fa-edit fa-3x"></i>Create Indoor Event </a></li> 
				   <li><a href="/Test/EventController?action=outdoorEvent&email=<c:out value="<%=email%>"/>"><i class="fa fa-edit fa-3x"></i>Create Outdoor Event </a></li> 
                ...
                <div class="row">
                    <div class="col-md-12">
                     <h2>Creating Event Form</h2>   
                        <h5>Hi <c:out value="<%=email%>" /> fill in the form to create indoor event</h5>
                    </div>
                </div>
        <!-- /. ROW  -->
                 <hr />
	...
	<!-- Child form -->
		<div class="form-group">
		<label>Indoor No:</label><br> 
		<input type="text" name="ieventid" > 
		</div>
		<div class="form-group">
		<label>Venue:</label><br> 
		<input type="text" name="ieventvenue">
		</div>
		<div class="form-group">
		<label>Date:</label><br> 
		<input type="text" name="ieventdate" placeholder="dd/mm/yyyy">
		</div>
		<div class="form-group">
		<label>Start Time: </label><br> 
		<input type="time" name="ieventstime"> 
		</div>
		<div class="form-group">
		<label>End Time: </label> <br> 
		<input type="time" name="ieventetime" >
		</div>
		<div class="form-group">
		<label>Guest Name:</label><br> 
		<input type="text" name="ieventguest" > 
		</div>
		<div class="form-group">
		<label>Event ID:</label> <br> 
		<input type="text" name="eventid">
