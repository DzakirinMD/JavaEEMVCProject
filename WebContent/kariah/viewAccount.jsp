                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="mx-auto d-block">
                                    ...
                                    <h5 class="text-sm-center mt-2 mb-1"><i class="fa fa-user"></i> <c:out value="${user.kariahname}" /></h5>           

		<p><strong>IC :</strong> <c:out value="${user.kariahic}" /></p>	
		<p><strong>Name :</strong> <c:out value="${user.kariahname}" /></p>
		<p><strong>Address:</strong> <c:out value="${user.kariahaddress}" /></p>
		<p><strong>Phone:</strong> <c:out value="${user.kariahnotel}" /></p>
		<p><strong>Email:</strong> <c:out value="${user.kariahemail}" /></p>
		<p><strong>Gender:</strong> <c:out value="${user.kariahgender}" /></p>
    	<br/>
